...
parser.add_argument('--dataroot', default="dataset/train", type=str, help='path to dataset')
parser.add_argument('--testfiles', default="test.list", type=str, help='the list of training files')
parser.add_argument('--testroot', default="dataset/test", type=str, help='path to dataset')
...
def main():
    ...
    groups = mag ** 2
    print("opt scale_back is " + str(opt.scale_back))
    if opt.scale_back:      
      is_scale_back = True
    else:      
      is_scale_back = False
    ...
    print("is_scale_back is " + str(is_scale_back))
        ...
        for iteration, batch in enumerate(train_data_loader, 0):
            ...
            if iteration % opt.test_iter is 0 and opt.test:
                ...
                for titer, batch in enumerate(test_data_loader,0):
                    ...
                    print("wavelets shape " + str(wavelets.size()))
                    prediction = wavelet_rec(wavelets)
                    print("prediction shape " + str(prediction.size()) + "  target shape " + str(target.size()))
